...
def set_config():
    ...
    config['Controls'] = {
        ...
        'tts_fuel_updates_toggle': Binds.keys["tts_fuel"],
        'txt_fuel_updates_toggle': Binds.keys["txt_fuel"],
        'temperature_toggle': Binds.keys["temp_updates"],
        'temperature_report': Binds.keys["temp_report"],
